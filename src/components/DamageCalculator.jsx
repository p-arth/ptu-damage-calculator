    ...
    <>
      <form className="form-app">
        ...
        <label className="form-app_label-click">
          STAB
          <input name="STAB" type="checkbox" checked={STABValue} onChange={handleSTABChange} />
        </label>
        ...
        <label className="form-app_label-click">
          Critical Hit
          <input name="Crit" type="checkbox" checked={critValue} onChange={handleCritChange} />
        </label>
        ...
        <div className="form-app_set-damage">
          <div className="form-app_set-damage_title">Defense / Sp. Defense</div>
        </div>
        <input
          type="text"
